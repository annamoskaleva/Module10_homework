...
// создаем объект websocket +  его действия
...
const error = () => {
    let error = "Your location is blocked" 
    addMessage(error);
}
...
//обработчик события при нажатии кнопки геопозиции
geoBtn.addEventListener('click', () => {
    if (!navigator.geolocation) {
        console.log("You can't use location")
    } else {
